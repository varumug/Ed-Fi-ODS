...
namespace EdFi.Ods.Api.IdentityValueMappers
{
    ...
    public interface IUniqueIdToIdValueMapper
    {
        ...
        /// <returns>The <see cref="PersonIdentifierTuple"/> containing the requested Id (if found), and possibly the
        /// corresponding Usi (depending on the implementation); otherwise a <see cref="PersonIdentifierTuple"/> instance
        /// containing default values.</returns>
        PersonIdentifierTuple GetId(string personType, string uniqueId);
        ...
        /// corresponding Usi (depending on the implementation); otherwise a <see cref="PersonIdentifierTuple"/> instance
        /// containing default values.</returns>
        PersonIdentifierTuple GetUniqueId(string personType, Guid id);
    }
}
